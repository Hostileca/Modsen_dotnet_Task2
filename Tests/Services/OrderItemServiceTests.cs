...
namespace Tests.Services
{
    public class OrderItemServiceTests
    {
        ...
        public async Task CreateOrderItemAsync_ValidDto_ReturnsOrderItemReadDto()
        {
            ...
            mockProductRepository.Setup(repo => repo.GetByIdAsync(createDto.ProductId)).ReturnsAsync(product);
            mockOrderRepository.Setup(repo => repo.GetByIdAsync(createDto.OrderId)).ReturnsAsync(order);
            _mockMapper.Setup(m => m.Map<OrderItem>(createDto)).Returns(orderItem);
            mockOrderItemRepository.Setup(repo => repo.AddAsync(orderItem)).Returns(Task.CompletedTask);
        ...
        public async Task DeleteOrderItemByIdAsync_ExistingId_ReturnsOrderItemReadDto()
        {
            ...
            mockOrderItemRepository.Setup(repo => repo.GetByIdAsync(orderItemId)).ReturnsAsync(orderItem);
        ...
        public async Task GetAllOrderItemsAsync_NoConditions_ReturnsListOfOrderItemReadDto()
        {
            ...
            mockOrderItemRepository.Setup(repo => repo.GetAllAsync()).ReturnsAsync(orderItems);
        ...
        public async Task UpdateOrderItemAsync_ValidDto_ReturnsUpdatedOrderItemReadDto()
        {
            ...
            mockOrderItemRepository.Setup(repo => repo.GetByIdAsync(orderItemId)).ReturnsAsync(existingOrderItem);
        ...
        public async Task DeleteOrderItemByIdAsync_NonExistingId_ThrowsKeyNotFoundException()
        {
            ...
            mockOrderItemRepository.Setup(repo => repo.GetByIdAsync(orderItemId)).ReturnsAsync((OrderItem)null);
